...
def letter_count(word):
    letter_totals = {}
    for letter in word:
        # I want to check at each letter if that letter exists in the object letter_totals. If it does, I want to add 1 to the value. If not I want the key to be created with a value of 1
